    ...
    <div class="home-content">
      <div class="logo mt20 mb20 f-r f-a-c f-j-s center">
        ...
        <el-input placeholder="请输入搜索内容" style="width:400px" v-model="search" class="search">
          <el-button slot="append" icon="el-icon-search" @click="$router.push('/search?search='+search)"></el-button>
        </el-input>
      </div>

      <div class="bor">
        <div class="center f-r r-a-c types p-r">
          <div class="type-row t-c" style="background:#409EFF;width:250px;color:#fff">
            商品分类
          </div>
      ...
      <div class="row-father center" v-for="item in list" :key="item.type">
        <div class="font22 mb20 mt40 font-white" style="font-weight:200;color:#333">{{item.type}}</div>
        <div class="rows">
