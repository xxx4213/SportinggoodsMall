  ...
  <div class="dashboard-container">
    ...
    <el-card slot class="content-card" shadow="never">
      <el-table :data="list" border stripe style="width: 100%;min-height: 60vh;">
        ...
        <el-table-column prop="uname" label="评论人" header-align="center" align="center" />
        <el-table-column prop="content" label="评论" header-align="center" align="center" />
        ...
        <el-table-column prop="address" label="操作" header-align="center" align="center" width="190px">
          <template slot-scope="scope">
            <div>
              <a style="margin-left:20px;color:rgb(31, 144, 254);" @click="edit(scope.row)">查看详情</a>
      ...
      <div slot>
        <el-form ref="addForm" :model="addForm" label-width="120px" class="addForm" label-position="right" size="small">
          <el-form-item label="评论人:">
            <el-input v-model="addForm.uname" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="评论图片:">
            <div class="f-r f-a-c">
              <div class="p-r f-r f-a-c" v-for="(item,index) in addForm.img" :key="index">
                <img :src="item" class="avatar mr10" style="border-radius:6px">
              </div>
            </div>
          </el-form-item>
          <el-form-item label="评论内容:">
            <el-input v-model="addForm.content" :rows="5" type="textarea" :disabled="true"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </Dialog>
...
export default {
  ...
  methods: {
    ...
    async confirm() {
      ...
      await api.commitsave(params).then(res => {
        if (res.code == 200) {
          this.$message.success("操作成功!");
    ...
    edit(item) {
      ...
      this.addForm.img = this.addForm.img.split(",");
