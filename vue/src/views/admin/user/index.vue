      ...
      <el-table :data="list" border stripe style="width: 100%;min-height: 60vh;">
        ...
        <el-table-column prop="img" label="头像" header-align="center" align="center">
          <template slot-scope="scope">
            <div>
              <img :src="scope.row.img" style="width:50px;height:50px;border-radius:50%">
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="user" label="账号" header-align="center" align="center" />
      ...
      <div slot>
        <el-form ref="addForm" :model="addForm" label-width="120px" class="addForm" label-position="right" size="small">
          ...
          <el-form-item label="居住地">
            <el-input v-model="addForm.addr" type="textarea" rows="4"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </Dialog>
